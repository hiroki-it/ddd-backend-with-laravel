 ...
 */
     ...
     */ 
         ...
         *
         * @return \App\Infrastructure\DTO\User|null 
         * @static 
         */ 
         ...
         *
         * @param mixed $id
         * @return \App\Infrastructure\DTO\User|false 
         * @static 
         */ 
         ...
         *
         * @return \App\Infrastructure\DTO\User 
         * @static 
         */ 
...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\MigrationMacroServiceProvider::register()
         * @static 
         */ 
        public static function systemColumns()
        {
                        return \Illuminate\Database\Schema\Blueprint::systemColumns();
        }
